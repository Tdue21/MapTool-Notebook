...
<table style="border:1px solid [r:if(iscrit==1,'cca300','Black')];margin: 0px; padding: 0px" width="150px">
	<tr>
...
[h,if(group3==100):row=row+1;""]
	...
	[h:critFormula=critFormula"+"+group2+"d"+group3]
...
[r,if(output!="all"):macroLink("[Share Result]","ShareRoll@Lib:Notebook","all",formula)]